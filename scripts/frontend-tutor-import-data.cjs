...
const schools = [
  {
    slug: 'amity-international-sector-46',
  ...
  },
  {
    ...
    address: 'DLF Phase 5',
    boards: ['CBSE', 'IB', 'IGCSE', 'ISC'],
  },
  {
    slug: 'dps-international-school',
    name: 'DPS International School',
    address: 'Sector 50',
    boards: ['CBSE', 'IB'],
  },
  {
    slug: 'manav-rachna-international-school',
  ...
  {
    slug: 'gems-international-school',
...
const societies = [
  { slug: 'dlf-park-place', name: 'DLF Park Place', sectorSlug: 'dlf-phase-5' },
  { slug: 'palm-springs', name: 'Palm Springs', sectorSlug: 'dlf-phase-5' },
  { slug: 'dlf-camellias', name: 'DLF Camellias', sectorSlug: 'sector-54' },
  { slug: 'pioneer-park', name: 'Pioneer Park', sectorSlug: 'sector-62' },
  { slug: 'dlf-aralias', name: 'DLF Aralias', sectorSlug: 'sector-53' },
  { slug: 'dlf-magnolias', name: 'DLF Magnolias', sectorSlug: 'sector-53' },
  { slug: 'm3m-golfestate', name: 'M3M Golfestate', sectorSlug: 'sector-65' },
  { slug: 'dlf-belaire', name: 'DLF Belaire', sectorSlug: 'dlf-phase-5' },
  { slug: 'hamilton-court', name: 'Hamilton Court', sectorSlug: 'dlf-phase-4' },
  { slug: 'nirvana-country', name: 'Nirvana Country', sectorSlug: 'sector-50' },
  { slug: 'uppal-southend', name: 'Uppal Southend', sectorSlug: 'sector-49' },
  { slug: 'm3m-merlin', name: 'M3M Merlin', sectorSlug: 'sector-67' },
];

const societyAliases = {
  'Park Place': 'dlf-park-place',
  'DLF Park Place': 'dlf-park-place',
  'Palm Springs': 'palm-springs',
  'The Camellias': 'dlf-camellias',
  'DLF Camellias': 'dlf-camellias',
  'Pioneer Park': 'pioneer-park',
  'DLF Aralias': 'dlf-aralias',
  'DLF Magnolias': 'dlf-magnolias',
  'M3M Golfestate': 'm3m-golfestate',
  'The Belaire': 'dlf-belaire',
  'DLF Belaire': 'dlf-belaire',
  'Hamilton Court': 'hamilton-court',
  'Nirvana Country': 'nirvana-country',
  'Uppal Southend': 'uppal-southend',
...
const tutors = [
  {
    ...
    tagline:
      'Senior Mathematics tutor for Class 10 and 12 students across CBSE, ICSE, and IB in Gurugram.',
    boards: ['CBSE', 'ICSE', 'IB'],
  ...
  },
  {
    ...
    tagline:
      'Mathematics specialist for Class 11, 12, and JEE preparation across CBSE, ISC, IGCSE, and IB pathways.',
  ...
  },
  {
    ...
    tagline:
      'Board-focused Mathematics and Accountancy tutor for Class 10, 11, and 12 students in Gurugram.',
  ...
  },
  {
    ...
    tagline:
      'Experienced Biology tutor for Class 10 and 12 students across CBSE, ICSE, ISC, and IB boards.',
    boards: ['CBSE', 'ICSE', 'ISC', 'IB'],
    subjects: ['Biology'],
    experienceYrs: 20,
    studentsTaught: 1600,
  ...
  },
  {
    ...
    tagline:
      'Senior English tutor for Class 10 and 12 students preparing across CBSE, ICSE, and IB boards.',
    boards: ['CBSE', 'ICSE', 'IB'],
    subjects: ['English'],
    experienceYrs: 18,
    studentsTaught: 1400,
  ...
  },
  {
    ...
    tagline:
      'Mathematics tutor for Class 10 and 12 students across CBSE, ICSE, and IB with home tutoring across Gurugram.',
    boards: ['CBSE', 'ICSE', 'IB'],
    subjects: ['Mathematics'],
    experienceYrs: 15,
    studentsTaught: 1100,
  ...
  },
  {
    ...
    tagline:
      'Hindi specialist for Class 10 students preparing for stronger board writing and language confidence.',
    boards: ['CBSE'],
    subjects: ['Hindi'],
    experienceYrs: 14,
    studentsTaught: 950,
