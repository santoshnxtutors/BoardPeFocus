    ...
    <div className="fixed bottom-4 right-4 sm:bottom-8 sm:right-8 z-[100] flex flex-col items-end gap-4">
      ...
      >
        <div className="flex items-center justify-between mb-4 sm:mb-6 border-b border-border/50 pb-4 sm:pb-5 sticky top-0 bg-white z-20">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <span className="block font-black text-primary text-sm sm:text-base uppercase tracking-tight">Academic Advisor</span>
      ...
      >
        {isOpen ? (
          ...
          <div className="relative">
             <MessageSquare className="w-7 h-7 sm:w-9 sm:h-9" />
