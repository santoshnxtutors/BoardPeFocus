  ...
  return (
    <section className="rounded-[2.5rem] border border-border/60 bg-primary px-6 py-10 text-white shadow-[0_30px_80px_rgba(21,48,96,0.16)] md:px-10 md:py-12">
      <div className="grid gap-8 xl:grid-cols-[minmax(0,1.1fr)_minmax(20rem,0.9fr)] xl:items-center">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.26em] text-white/60">Results CTA</p>
        ...
        <div className="grid gap-3 sm:grid-cols-2 2xl:grid-cols-3">
          <Link
            href="https://wa.me/918796367754?text=Hi%20BoardPeFocus%2C%20I%20want%20to%20discuss%20a%20results-oriented%20tutoring%20path."
            target="_blank"
