...
import { MessageCircle, Phone, Search, ChevronRight, HelpCircle, ShieldCheck, BookOpen, CreditCard, Mail } from "lucide-react";
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <aside className="lg:w-80 flex-shrink-0">
              <div className="sticky top-28 space-y-4">
                <h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-6 ml-4">Categories</h3>
